...
export type EventBusEvent =
  ...
  | { type: 'request-wish-name'; propId: string }
  | { type: 'wish-name-set'; propId: string; name: string }
  | { type: 'request-set-scene'; key: string }
  | { type: 'request-set-background'; key: string }
